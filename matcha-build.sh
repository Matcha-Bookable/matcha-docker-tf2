...
# Matcha-Bookable (matcha-bookable/sourcepawn-matcha-bookable)
wget -nv https://github.com/matcha-bookable/sourcepawn-matcha-bookable/raw/main/plugins/matcha-bookable.smx
