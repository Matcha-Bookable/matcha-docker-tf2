...
sm_url=$(wget -q -O - "https://www.sourcemod.net/downloads.php?branch=stable" | grep -oP -m1 'https://github\.com/alliedmodders/sourcemod/releases/download/[0-9.]+/sourcemod-.*?-linux\.tar\.gz')
